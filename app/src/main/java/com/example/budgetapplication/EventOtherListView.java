...
public class EventOtherListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_other_list_view);
        ...
        selectedEventItemsList=bundle.getStringArrayList("selectedoTHERItems");
        budgetAmount = Integer.parseInt(bundle.getString("oTHERAmount"));
        crowd = Integer.parseInt(bundle.getString("Othercrowd"));
    ...
    private void saveEventBudget(){
        ...
        if(TextUtils.isEmpty(eventName)){
            ...
            EventBudgetModel eventBudgetModel = new EventBudgetModel(id,eventName,crowd.toString(),budgetAmount.toString(),totalBudgetAmount.toString(),eventModelList,"Other");
